	...
	<nav class="main">
		<ul>
			...
			<sec:authorize access="isAuthenticated()">
				<li class="user mypage"><strong>MyPage</strong><span>(<sec:authentication
							property="principal.email" />)
				</span></li>
				<li class="user logout"><f:form
						action="${rootPath }/user/logout" onclick="this.submit()">로그아웃</f:form></li>
			</sec:authorize>
