...
public class HomeController {
	 ...
	 * 생성한 후 사용해야한다.
	 * 
	 * Spring 에서는 클래스의 생성자를 호출하여 객체를 생성하는 경우가 극히 드물다. Service 클래스를 Controller 등에서
	 * 사용하기 위해서는 Service 클래스의 @Service Annotation 을 부착하여 Spring Server 가 시작될때 Scan
	 * 하도록 하여두고 필요한 곳에서 생성자를 통하여 주입받아서 사용한다. 필요한 곳에서 필요하다고 선언만 해두면, 생성된 객체를 자동으로
	 * 공급하여 준다. 기존의 자바코드와 비교하면 객체를 생성하는 방향이 반대이다. 이러한 것을 제어의 역전(Inverted of Control
	 * , IoC)
	 */
